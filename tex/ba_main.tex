...
%		\end{table}
	...
	\section{Physikalische Grundlagen}\label{sec:physg}
		...
		Der Ladungsträgerstrom, welcher letztendlich den Parameter der Partikelladung bestimmt, ergibt sich aus der Aufsummierung aller Stromdichten aus Teilchen der Geschwindigkeiten $v\ix{j}$:
