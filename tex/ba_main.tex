	...
	\section{Auswertung}\label{sec:auswert}
		...
		Es schließt sich die Beschreibung einer Auswahl der einsichtigsten und am besten nachvollziehbaren Messdaten an. 
			...
			\subsubsection{Auswertung}
				...
				Mit den Ergebnissen der \ref{img:randfrequenz} bis \ref{img:randhochutiefrotat} ist die Methodik der Versuche um das Plasma-Glow prinzipiell bestätigt. Die Potentiale der Segmente der Ring-Elektrode beeinflussen die Randschicht in dessen näherer Umgebung. Dies ist der, damit einher gehenden Veränderung des Leuchtens der Neutralgasatome zu entnehmen. 
				...
				\paragraph{Dipol-Anregung}
						...
						\begin{figure}[!b]
							...
							\caption{Vergleich der Intensitätsverläufe bei $\unit[181]{\degree}$  und $\unit[331]{\degree}$ der Dipol-Anregung von \ref{img:randfrequenz} bei $\unit[3]{Hz}$ für $\unit[1]{s}$. $I\left(\varphi=\unit[331]{\degree}\right)$ ist um 66 \tilt{frames} verzögert, damit die Extrema übereinander liegen.}
				...
				\paragraph{Quadrupol-Anregung}
						...
						\begin{figure}[!b]
							...
							\end{subfigure}
							\caption{Intensitätsverläufe der Quadrupol-Anregung aus \ref{img:randhochutiefwink}:\underline{\fett{links}} bei $\unit[3]{Hz}$ für $\unit[1]{s}$. \underline{\fett{links}:} Bei $\unit[181]{\degree}$ und $\unit[83]{\degree}$. \underline{\fett{rechts}:} Für $\unit[181]{\degree}$  und $\unit[0]{\degree}$. }
