...
%		\end{table}
	...
	\section{Durchführung}\label{sec:durch}
		...
		\subsection{Strereoskopie und Bildrekonstruktion}
			...
			Beleuchtet wurde der Yukawa-Ball mit 2 gr\"unen Neodym-dotieren YAG-Lasern, welche bei einer Wellenl\"ange von $\unit[532]{nm}$ und mit einer Leistung von $\unit[600]{mW}$ abstrahlten. Die Strahlf\"uhrung war hierbei \"au{\ss}erst kompliziert, da erst \"uber Strahlaufweiter und Spiegel die Laser diagonal durch die Entladung geleitet wurden. Strahlprofil und Strahlungsdruck (siehe \ref{subsub:laser}) sind durch den Aufbau so konstruiert, dass sie f\"ur die Dynamik des Clusters unkritisch sind. 
