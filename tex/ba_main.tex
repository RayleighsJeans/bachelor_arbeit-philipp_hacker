...
%		\end{table}
	...
	\section{Physikalische Grundlagen}\label{sec:physg}
				...
				\begin{table}[H]
					\centering
						\begin{tabular}{m{0.3\textwidth}|m{0.3\textwidth}|m{0.3\textwidth}}
							...
							\hline mittlerer Teilchenabstand & $b=\frac{\hbar}{m\ix{j}v\ix{th,j}}$ & gemittelter Teilchenabstand, entspricht thermischer \mbox{\tilt{de-Broglie}-Wellenlänge} \\ 
		...
		\subsection{Finite Yukawa-Cluster}\label{sub:yukawaclust}
			...
			Bisher wurden in den Abschnitten \ref{sub:kaprfplasm} und \ref{sub:rand} allgemein gültige Charakteristika des für diesen Aufbau verwendeten Plasmas besprochen. Außerdem finden sich in \ref{sub:ströme} und \ref{sub:dynamik} die für komplexe bzw. staubige Plasmen spezifischen Kenngrößen und Prozesse, wie beispielsweise Aufladung und Einfang, wieder. Doch 
