...
%				\caption{Ein \tilt{frame} der Oberkamera ohne Filter für das Licht der Argon-Entladung. Die Helligkeit in der Mitte des 4-segmentigen Ringes in einer Höhe von $\unit[1,2]{cm}$ ist geringer als außerhalb: die Randschicht ist dort deutlich vergrößert.}
%				\label{img:glow}
%			\end{wrapfigure}
